...
| 6.5 | **비공개 테스트 개시**(2026-08-14 사용자 결정 — 14일 시계 병행) | 🔨 — Play 콘솔 앱 생성 ✅ · Alpha 트랙 국가 177개 ✅ · 테스터 목록(조각 2명 재사용) ✅ · 출시 초안 저장 ✅. **남음: ① AAB 업로드(64.9MB — 사용자 드래그, `linkmemo-vc1.aab`) ② 테스터 12명 채우기 ③ 앱 콘텐츠 필수 설문(처리방침 URL·광고·콘텐츠 등급·타겟층·데이터 보안) ④ 검토 전송** |
