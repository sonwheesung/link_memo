...
| 하단 배너 광고 | ✅ | 2026-08-14 Phase 6 — 실 AdMob 배너(dev=테스트 단위), 미수신 시 자리 미점유 |
| **App Open 광고(콜드 스타트 · 쿨타임 3시간)** | ✅ | 2026-08-14 Phase 6 — 복귀 노출 없음, 로드 8초 타임아웃 |
| UMP 동의 폼(EEA 포함 출시) | ✅ | 2026-08-14 Phase 6 — 콘솔 GDPR 메시지 게시 + AdsConsent 흐름 |
| ⚠ **Expo Go 종료** | — | 2026-08-14 — 광고 SDK(네이티브) 설치. 이후 개발은 dev build(`npm run android`) |
...
| AdMob 앱·광고단위(배너 1 · **App Open** 1) + GDPR 메시지 설정 | ✅ | 2026-08-14 — ID·게시 상태는 [`MONETIZATION_SYSTEM.md`](./MONETIZATION_SYSTEM.md) §3.1. ⚠ 처리방침 URL 약속 주소 참조 |
